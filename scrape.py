...
stock_symbols = ['AAPL', 'GOOGL', 'AMZN', 'MSFT', 'TSLA', 'META', 'NFLX', 'NVDA', 'SPY', 'BA']
...
for symbol in stock_symbols:
    try:
        ...
        # Extract the latest OHLC (Open, High, Low, Close)
...
if not df.empty:
    ...
    df_sorted = df.sort_values(by='Current Price', ascending=False).head(5)
